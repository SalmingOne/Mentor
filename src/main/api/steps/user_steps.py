...
class UserSteps(BaseSteps):
    ...
    def deposit_account_bad(self, create_user_request: CreateUserRequest, deposit_account_request: DepositAccountRequest, response_spec=ResponseSpecs.request_bad()):
    ...
    def transfer_account_bad(self, create_user_request: CreateUserRequest, transfer_account_request: TransferAccountRequest, response_spec=ResponseSpecs.request_bad()):
        response = CrudRequester(
            request_spec=RequestSpecs.auth_headers(username=create_user_request.username,
                                                   password=create_user_request.password),
            response_spec=response_spec,
    ...
    def request_credit_bad(self, create_user_request: CreateUserRequest, request_credit_request: RequestCreditRequest, response_spec=ResponseSpecs.request_bad()):
        response = CrudRequester(
            request_spec=RequestSpecs.auth_headers(username=create_user_request.username,password=create_user_request.password),
            response_spec=response_spec,
            endpoint=Endpoint.REQUEST_CREDIT
    ...
    def repay_credit_bad(self, create_user_request: CreateUserRequest, repay_credit_request: RepayCreditRequest, response_spec=ResponseSpecs.request_bad()):
        response = CrudRequester(
            request_spec=RequestSpecs.auth_headers(username=create_user_request.username,
                                                   password=create_user_request.password),
            response_spec=response_spec,
